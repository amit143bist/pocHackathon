 ...
 *     &lt;enumeration value="TAYubiHyojyunKaisyo"/>
 *     &lt;enumeration value="TASourinFude02"/>
 *     &lt;enumeration value="TAAkiko"/>
 *     &lt;enumeration value="TAAsako"/>
 *   &lt;/restriction>
 * &lt;/simpleType>
 * </pre>
 * 
...
public enum FontStyleCode {
    ...
    @XmlEnumValue("TAYubiHyojyunKaisyo")
    TA_YUBI_HYOJYUN_KAISYO("TAYubiHyojyunKaisyo"),
    @XmlEnumValue("TASourinFude02")
    TA_SOURIN_FUDE_02("TASourinFude02"),
    @XmlEnumValue("TAAkiko")
    TA_AKIKO("TAAkiko"),
    @XmlEnumValue("TAAsako")
    TA_ASAKO("TAAsako");
