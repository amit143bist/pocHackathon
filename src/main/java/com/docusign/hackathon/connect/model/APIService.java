 ...
 * 
 */
@WebServiceClient(name = "APIService", targetNamespace = "http://www.docusign.net/API/3.0", wsdlLocation = "https://www.docusign.net/api/3.0/api.asmx?wsdl")
public class APIService
    extends Service
{

    private final static URL APISERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.docusign.hackathon.connect.model.APIService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.docusign.hackathon.connect.model.APIService.class.getResource(".");
            url = new URL(baseUrl, "https://www.docusign.net/api/3.0/api.asmx?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'https://www.docusign.net/api/3.0/api.asmx?wsdl', retrying as a local file");
